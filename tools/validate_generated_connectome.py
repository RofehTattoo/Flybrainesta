#!/usr/bin/env python3
"""Independent structural validation for the current FlyBrain FBR-10-OLF1 release."""
...
EDGE_SIZE = 12
HEADER_SIZE = 16
EXPECTED_SHA = "0044ab166af3439f2b86d4e6c5897481a1c3f28a58b6afb2c4f761489b276bbf"
...
def main(root: Path|None=None) -> None:
    ...
    assert report["flybrain_version"]=="1.17.0"
    ...
    assert re.search(r'const val REDUCTION_ID = "FBR-10-OLF1"', meta)
    assert data[:8]==MAGIC
    ...
    assert actual==EXPECTED_SHA==report["sha256"]
    seen=set(); contacts=0
    for i in range(e):
    ...
    assert prev==TARGET
    print(f"GENERATED FBR-10-OLF1: PASS ({n} neurons, {e} edges, {contacts} contacts, {actual})")
