...
assert 'APP_VERSION = "1.18.5"' in META
assert 'APP_VERSION_CODE = 138' in META
assert 'REDUCTION_ID = "FBR-10-OLF2-MOTORROUTE"' in META
assert 'versionName = "1.18.5"' in GRADLE
assert 'versionCode = 138' in GRADLE
...
print('V1.18.5 REFERENCE LIF INTEGRATION AUDIT: PASS')
